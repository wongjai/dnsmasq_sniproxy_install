...
install_dnsmasq(){
    ...
    download /tmp/proxy-domains-youtube.txt https://raw.githubusercontent.com/codionx/dnsmasq_sniproxy_install/master/proxy-domains-youtube.txt
    ...
    cd /tmp
    rm -rf /tmp/dnsmasq-2.80 /tmp/dnsmasq-2.80.tar.gz /tmp/proxy-domains-youtube.txt
...
install_sniproxy(){
    ...
    download /tmp/sniproxy-domains.txt https://raw.githubusercontent.com/codionx/dnsmasq_sniproxy_install/master/proxy-domains-youtube.txt
